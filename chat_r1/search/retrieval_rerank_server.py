    ...
    for i, doc_scores in reranked.items():
        ...
        if request.return_scores:
            ...
            for doc, score in doc_scores:
                combined.append({"document": {"contents": convert_title_format(doc)}, "score": score}) # convert_title_format on doc before
            response.append(combined)
        else:
            response.append([{"contents": convert_title_format(doc)} for doc, _ in doc_scores]) # convert_title_format on doc
